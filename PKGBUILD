...
source=(http://www.eu.apache.org/dist/incubator/${pkgname}/apache-${pkgname}-${pkgver}-incubating/apache-${pkgname}-${pkgver}-incubating.tar.gz
        zookeeper_zoo.cfg
...
sha256sums=('8881e8e95bc8bc258dcba7b8be0b7ded942795f69f4aa6c682c9f3c4d927c492'
...
package() {
  cd "${srcdir}/apache-${pkgname}-${pkgver}-incubating"
